...
for (const script of scripts) {
  ...
  if (mp3Match2) return { mp3: mp3Match2[0].slice(1, -1), title: episodeTitle };
    ...
    if (result.mp3) {
      ...
      const tvgLogoUrl = 'https://raw.githubusercontent.com/malimujo/HRT-Poslovni-tjedan/main/poslovnitjedan.png';
...
${result.mp3}`;
      ...
      console.log('✅ M3U spreman s fiksnom slikom!');
    } else {
...
#EXTINF:-1 tvg-logo="https://raw.githubusercontent.com/malimujo/HRT-Poslovni-tjedan/main/poslovnitjedan.png",HRT Povijest četvrtkom - Projekt Manhattan II. dio 11.03. 20:00
https://api.hrt.hr/media/28/da/20260311-povijest-cetvrtkom-37328740-20260311200000.mp3`;
    ...
    console.log('✅ Fallback M3U spreman s fiksnom slikom');
  } finally {
    if (browser) {
      await browser.close();
    }
